        ...
        <form action="/materiel/processModifier/<?php echo $materiel['id_materiel']; ?>" method="post" id="form-modifierMateriel">
            ...
            <div class="form-group">
                ...
                <input type="text" name="nom" id="nom"
                    value="<?php echo htmlspecialchars($materiel['nom']); ?>" required>
            </div>

            <div class="form-group">
                <label for="modele">Modèle *</label>
                <input type="text" name="modele" id="modele"
                    value="<?php echo htmlspecialchars($materiel['modele'] ?? ''); ?>" required>
            </div>

            <div class="form-group">
                <label for="numero_serie">Numéro de série *</label>
                <input type="text" name="numero_serie" id="numero_serie"
                    value="<?php echo htmlspecialchars($materiel['numero_serie'] ?? ''); ?>" required>
            </div>
            ...
            <div class="form-group">
                ...
                <select name="id_categorie" id="id_categorie" required>
                    ...
                    <option value="1" <?php echo $materiel['id_categorie'] == 1 ? 'selected' : ''; ?>>Ordinateur</option>
